...
if __name__ == "__main__": 
	...
	#buttons for arithematic operators .
	...
	sine = Button(gui, text=' sin ', fg='black', bg='green', 
				command=math.sin, height=1, width=7) 
	math.sin.grid(row=2, column=4) 
